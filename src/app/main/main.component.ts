...
export class MainComponent implements OnInit {
  ...
  dropdownSections = [
    ...
    },
    {
      ...
      url: [
        'featuresHeading',
        'featuresTileheading1',
        'featuresTilebody1',
        'featuresTileheading2',
        'featuresTilebody2',
        'featuresTileheading3',
        'featuresTilebody3',
      ],
      postion: 530,
    },
    ...
    },
    {
      ...
      url: [
        'sellingPointsLogo1',
        'sellingPointsHeading1',
        'sellingPointsBody1',
        'sellingPointsLogo2',
        'sellingPointsHeading2',
        'sellingPointsBody2',
        'sellingPointsLogo3',
        'sellingPointsHeading3',
        'sellingPointsBody3',
      ],
      postion: 4200,
    },
  ...
  toggleDropdown(event: Event, sectionName: string, sectionPostion: number) {
    const section = this.dropdownSections.find(
  ...
  getData() {
    this.mainService.getNavData('component/navbar').subscribe((data) => {
      this.nav = data;
      this.listItems = this.nav.data.listItems;
